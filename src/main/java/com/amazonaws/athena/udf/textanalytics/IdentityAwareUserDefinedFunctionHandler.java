 ...
 */
public abstract class IdentityAwareUserDefinedFunctionHandler
        implements RequestStreamHandler {

    private static final Logger logger = LoggerFactory.getLogger(IdentityAwareUserDefinedFunctionHandler.class);
    ...
    public IdentityAwareUserDefinedFunctionHandler(String sourceType) {
    ...
    protected UserDefinedFunctionResponse processScalarFunction(BlockAllocator allocator, UserDefinedFunctionRequest req)
        ...
        Block outputRecords = processRows(allocator, udfMethod, inputRecords, outputSchema, req.getIdentity());
     ...
     */
    protected Block processRows(BlockAllocator allocator, Method udfMethod, Block inputRecords, Schema outputSchema, FederatedIdentity identity)
            throws Exception {
